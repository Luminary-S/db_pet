...
book = xlrd.open_workbook("名单.xlsx") # excel文件名
sheet = book.sheet_by_name("名单") # excel文件中的sheet名

# 建立一个MySQL连接
database = pymysql.connect(host="localhost", user="root", passwd="123456", db="wjh")
